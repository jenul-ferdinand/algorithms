...
class TestPokeTeam(unittest.TestCase):
    ...
    def test_regenerate_team(self):
        ...
        self.assertGreater(
            poketeam.team.array[0].get_health(),
            0,
            "Regenerate team not configured properly",
        )
    ...
    def test_internals(self):
        ...
        self.assertIsNotNone(
            poketeam[0], " Poketeam's __getitem__ not working correctly"
        )
...
class TestTrainer(unittest.TestCase):
    ...
    def test_pick_team(self):
        ...
        self.assertEqual(
            type(trainer.get_team()),
            type(sample),
            "Trainer pick_team isn't set up correctly",
        )
    ...
    def test_get_name(self):
        trainer = Trainer("Ash")
        self.assertEqual(
            trainer.get_name(), "Ash", "Trainer get_name not set up correctly"
        )
    ...
    def test_str(self):
        ...
        self.assertEqual(
            str(trainer),
            expected_str,
            "Trainer Str method is not set up correctly",
        )
