...
Source material: `notes06.pdf`, `fermat-little-theorem.pdf`, `seminar06.pdf`.
Lab exercises drawn from `lab06.pdf` are woven in as checkpoints under each topic.

Legend: `[ ]` concept / theorem / proof to learn. `[ ] Lab Qx`: lab question. `[ ] Impl`: implementation exercise. Goals describe what "done" looks like.
