...
- [ ] Why neither worst-case nor best-case nor average-case suffices
...
- [ ] What amortized analysis provides
...
- [ ] Aggregate method (mathematician's view)
...
- [ ] Bit-flip frequency by position
...
- [ ] Lab Q1(a): aggregate amortised cost of increment
...
- [ ] Amortised cost per increment is O(1)
...
- [ ] Lab Q1(b): accounting amortised cost of increment
...
- [ ] Lab Q1(c): potential amortised cost of increment
...
- [ ] The potential function (slide 29)
...
- [ ] Why the coefficient on nMarked is 2 (not 1)
...
- [ ] Lab Q2(a): amortised cost of insert is O(1)
    - True cost: O(1). Phi change: nTrees += 1, nMarked unchanged. Delta Phi = 1.
    - Amortised: 1 + 1 = 2 = O(1).
    - Goal: produce the proof.
- [ ] Lab Q2(b): amortised cost of extract-min is O(log N)
...
- [ ] Lab Q2(c): amortised cost of decrease-key is O(1)
...
- [ ] Step 1 (Lab Q1): write up all three amortised analyses for the k-bit binary counter.
    - Files: `lab/binary_counter_aggregate.md`, `lab/binary_counter_accounting.md`, `lab/binary_counter_potential.md`.
- [ ] Step 2 (Lab Q3): write up all three amortised analyses for dynamic-array append.
    - Files: `lab/dyn_array_aggregate.md`, `lab/dyn_array_accounting.md`, `lab/dyn_array_potential.md`.
- [ ] Step 3 (Lab Q2): write up the Fibonacci heap amortised analyses for insert, extract-min, decrease-key under Phi(H) = nTrees + 2 * nMarked.
